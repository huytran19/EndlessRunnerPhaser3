...
export default class GameScene extends Phaser.Scene {
  ...
  private prepareJump: boolean = false;
  ...
  preload() {
    this.load.image('flash', 'explosion00.png');
  }
  ...
  create(): void {
    ...
    const square = new Phaser.Geom.Rectangle(0, 0, 40, 40);
    const particle = this.add.particles('flash');
